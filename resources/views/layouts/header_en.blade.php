...
<head>
    ...
    <script type="application/ld+json">
        {"@context":"https:\/\/schema.org","@type":"WebSite","url":"https:\/\/fleetcart.envaysoft.com\/en","potentialAction":{"@type":"SearchAction","target":"https:\/\/fleetcart.envaysoft.com\/en\/products?query={search_term_string}","query-input":"required name=search_term_string"}}
    </script>
...
<body class="page-template ltr" data-theme-color="green" style="--color-primary: green;
                ...
                <div class="top-nav">
                    <div class="row justify-content-between">
                        <div class="top-nav-left d-none d-lg-block">
                            <span>Bienvenue au notre Site FORVER PRODUCTS</span>
                        </div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 147 31"
                                    ...
                                    <g>
                                        <g transform="translate(-164 -55)">
                                            ...
                                            <text transform="translate(201 80)" fill="#6e6e6e" font-size="22"
                ...
                <div class="navigation-inner">
                    ...
                    <nav class="navbar navbar-expand-sm">
                        <ul class="navbar-nav mega-menu horizontal-megamenu">
                            ...
                            <li class="nav-item">
                                <a href="https://codecanyon.net/item/fleetcart-laravel-ecommerce-system/23014826" class="nav-link menu-item"
                                    target="_blank" data-text="BUY THEME!">
                                    BUY THEME!
                                </a>
                            </li>
                        </ul>
